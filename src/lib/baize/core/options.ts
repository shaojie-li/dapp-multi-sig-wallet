...
export class Options {
    beforeAppAjaxSend: Function | undefined
    enableTraceId: boolean | undefined
    filterXhrUrlRegExp: RegExp | undefined
    includeHttpUrlTraceIdRegExp: RegExp | undefined
    traceIdFieldName: string | undefined = "Trace-Id"
    constructor() {
